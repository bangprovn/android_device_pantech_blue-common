...
$(INSTALLED_BOOTIMAGE_TARGET): $(PRODUCT_OUT)/kernel $(uncompressed_ramdisk) $(recovery_uncompressed_ramdisk) $(INSTALLED_RAMDISK_TARGET) $(INITSH) $(BOOTREC_DEVICE) $(PRODUCT_OUT)/utilities/busybox $(PRODUCT_OUT)/utilities/extract_elf_ramdisk $(MKBOOTIMG) $(MINIGZIP) $(INTERNAL_BOOTIMAGE_FILES)
	...
	$(hide) python $(MKELF) -o $@ $(PRODUCT_OUT)/kernel@0x80208000 $(PRODUCT_OUT)/combinedroot.fs@$(pantech_FORCE_RAMDISK_ADDRESS),ramdisk vendor/pantech/blue-common/proprietary/boot/RPM.bin@0x20000,rpm device/pantech/blue-common/rootdir/cmdline.txt@cmdline
...
$(INSTALLED_RECOVERYIMAGE_TARGET): $(MKBOOTIMG) \
	...
	$(hide) python $(MKELF) -o $@ $(PRODUCT_OUT)/kernel@0x80208000 $(PRODUCT_OUT)/ramdisk-recovery.img@$(pantech_FORCE_RAMDISK_ADDRESS),ramdisk vendor/pantech/blue-common/proprietary/boot/RPM.bin@0x20000,rpm device/pantech/blue-common/rootdir/cmdline.txt@cmdline
